...
.rating-circle:after {
  ...
  background: #fff;
  top: -10px;
  border-radius: 0px 183px 59px 55px;
  background: radial-gradient(circle at top left, transparent 47%, white 46.5%);
...
.rating-circle:before {
  ...
  background: #fff;
  bottom: -55px;
  border-radius: 0px 217px 33px 74px;
